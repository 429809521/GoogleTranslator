// Copyright (c) 2016 Julian Sychowski - changed the URLs to secret translate.googleapis.com API that is internally used by the Google Translate extension for Chrome and requires no authentication. Additionally Newtonsoft.Json parser is used for simplicity and reliability.
// Copyright (c) 2015 Ravi Bhavnani - original code using old API and own json parsing method
