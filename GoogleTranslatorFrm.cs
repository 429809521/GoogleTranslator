// Copyright (c) 2016 Julian Sychowski - using WMPLib.WindowsMediaPlayer to play _translationSpeakUrl.
// Copyright (c) 2010 Ravi Bhavnani - original version
    ...
    public partial class GoogleTranslatorFrm : Form
    {
        ...
        #region Form event handlers
                 ...
                 EventArgs e)
            {
                ...
                this._comboFrom.SelectedItem = "Polish";
        ...
        #region Button handlers
                 ...
                 EventArgs e)
            {
                if (!string.IsNullOrEmpty (this._translationSpeakUrl)) {
                    ...
                    a.URL = this._translationSpeakUrl; //mp3 file
                    //a.controls.play(); //autoplay is enabled
                }
            }
